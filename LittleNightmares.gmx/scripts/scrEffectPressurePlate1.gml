...
part_type_color3(particle1,c_lime,c_green,c_dkgreen);
...
part_emitter_region(Sname,emitter1,x+16,x+16,y+16,y+16,0,0);
...
part_type_color3(particle2,c_lime,c_green,c_dkgreen);
