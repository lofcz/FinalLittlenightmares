...
part_type_size(particle1,0.10,0.20,0.20,0);
part_type_scale(particle1,1,1);
part_type_color3(particle1,65535,33023,255);
part_type_alpha1(particle1,1);
part_type_speed(particle1,1,1,-0.20,0);
part_type_direction(particle1,0,359,0,0);
part_type_gravity(particle1,0,270);
part_type_orientation(particle1,0,0,10,20,1);
part_type_blend(particle1,1);
part_type_life(particle1,40,40);
emitter1 = part_emitter_create(Sname);
part_emitter_region(Sname,emitter1,x,x,y,y,2,1)
