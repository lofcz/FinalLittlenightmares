...
if (sprite_exists(spr)) {
    draw_sprite_stretched(spr,-1,xx,yy,(xx+170)-xx,(yy+240)-yy)
} else {
    draw_set_color(bgcol)
    draw_rectangle(xx,yy,xx+172,yy+240,0)
    draw_set_alpha(1)
    draw_set_color(c_black)
    draw_rectangle(xx,yy,xx+172,yy+240,1)
}
draw_set_alpha(1)
draw_set_color(c_black)
var a,b,no;
